...
public class Profile {
	...
	public Profile(Integer id, Integer careerId, String name, Date dateOfbirth, String nationality, String email,
			String phoneNumber, String describeCurrentJob, String expAbroad, String expOthers, String qualifications,
			String joiningPeriod, String currentSalary, String expSalary, String presentLocation) {
		super();
		this.id = id;
